...
export declare class RFIDNotification {
    /** RFID notification code. */
    readonly notificationCode: RFIDNotificationCodes;
    /**
     ...
     */
    readonly dataFileType: RFIDDataFileType;
    /** RFID progress. */
 ...
 */
export declare enum RFIDNotificationCodes {
